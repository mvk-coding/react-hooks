...
> I'm already using hooks in my coding, still it is good to understand why 
> useState() is combined with destructering. I was not aware that the useState hook
> returned an array. Knowing more about the way these hooks works helps to understand 
> why they are used in a particular way in code.
